    ...
    <a-form :model="form" layout="vertical">
      ...
      <a-form-item field="bgImage" label="背景图片">
        <div class="upload-area">
          <a-input v-model="form.bgImage" placeholder="支持输入URL或上传本地图片" style="flex: 1; margin-right: 10px;" />
      ...
      <a-form-item label="数据操作">
        <a-space wrap>
          <a-popconfirm content="警告：这将清空所有人员、奖项设置和抽奖记录！此操作不可恢复！" @ok="resetAll">
            <a-button status="danger">重置整个系统</a-button>
          </a-popconfirm>

          <a-popconfirm content="这将覆盖当前所有数据，生成100名测试人员和5组奖项。确定继续吗？" @ok="generateTestData">
